<?php
    ...
    if(array_key_exists("font", $_POST)) {
        $google_font = $_POST["font"];
        if(preg_match('/\w+$/', $google_font)) {
            $google_font_html = '<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=' . $google_font . '" type="text/css" />';
        }
    }
